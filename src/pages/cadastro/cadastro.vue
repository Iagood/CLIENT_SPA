<template>
  <loginTemplate>
    ...
    <span slot="menuesquerdo">
         ...
         <img src="https://png.pngtree.com/png-vector/20191003/ourmid/pngtree-user-login-or-authenticate-icon-on-gray-background-flat-icon-ve-png-image_1786166.jpg" alt="" class="circle responsive-img"/>
